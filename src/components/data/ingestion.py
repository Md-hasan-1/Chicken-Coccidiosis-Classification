...
class DataIngestion:
    ...
    def get_training_testing_splits(self, raw_data_dir:str)-> None:
        ...
        try:
            ...
            training_dataset_dir_path = DataIngestionConfig.training_data_dir
            testing_dataset_dir_path = DataIngestionConfig.testing_data_dir
    ...
    def get_train_val_splits(self, training_data_dir:str)-> None:
        ...
        try:
            ...
            train_dataset_dir_path = DataIngestionConfig.train_data_dir
            val_dataset_dir_path = DataIngestionConfig.val_data_dir
    ...
    def start(self)-> None:
        """Description: No needed to run all methods separately just run this method all methods will automatically will be called.
        """
        try:
            logging.info("Data ingestion initiated")
            create_dirs(DataIngestionConfig.dir_path)
            self.download(
                DataIngestionConfig.source_uri, 
                DataIngestionConfig.zip_file_path
            )
            self.extract(
                DataIngestionConfig.zip_file_path,
                DataIngestionConfig.raw_data_dir
            )
            self.get_training_testing_splits(
                DataIngestionConfig.raw_data_dir
            )
            self.get_train_val_splits(
                DataIngestionConfig.training_data_dir
            )
